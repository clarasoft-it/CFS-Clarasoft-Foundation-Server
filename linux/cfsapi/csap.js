...
function CSAP_Session() {
    ...
    function Send(userCtlFrame) {
        ...
        var outFrame = ReqCtlFrame + userCtlFrame + OutMessage;
            ...
            case "CSAP_HANDSHAKE":
	  	    ...
	  	    case "CSAP_DATA":
                ...
                try {
                    ...
                    var UsrCtlFrameSize = parseInt(CtlFrame.substring(60,70), 10);

                    if (UsrCtlFrameSize > 0) {
                        UsrCtlFrame = InMessage.substring(80, 80 + UsrCtlFrameSize);
                    }
                    else {
                        UsrCtlFrame = "";
                    }

                    var DataSize = parseInt(CtlFrame.substring(70,80), 10);

                    if (DataSize > 0) {
                        MessageData = InMessage.substring(80 + UsrCtlFrameSize);
                    }
                    else {
                        MessageData = "";
                    }
